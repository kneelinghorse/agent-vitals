...
def run_backtest(
    ...
    *,
    ...
    config_summary = {
        ...
        "causal_confab_window_size": cfg.causal_confab_window_size,
        "causal_confab_baseline_floor": cfg.causal_confab_baseline_floor,
        "causal_confab_weak_link_threshold": cfg.causal_confab_weak_link_threshold,
        "causal_confab_structural_drop_threshold": cfg.causal_confab_structural_drop_threshold,
        "causal_confab_ratio_gate": cfg.causal_confab_ratio_gate,
        "causal_confab_low_link_threshold": cfg.causal_confab_low_link_threshold,
        "causal_confab_source_bootstrap_cap": cfg.causal_confab_source_bootstrap_cap,
        "causal_confab_low_link_ratio_gate": cfg.causal_confab_low_link_ratio_gate,
        "causal_confab_verified_link_floor": cfg.causal_confab_verified_link_floor,
        "causal_confab_verified_weak_threshold": cfg.causal_confab_verified_weak_threshold,
        "causal_confab_verified_drop_threshold": cfg.causal_confab_verified_drop_threshold,
        "causal_confab_verified_ratio_gate": cfg.causal_confab_verified_ratio_gate,
        "causal_confab_verified_min_sources": cfg.causal_confab_verified_min_sources,
