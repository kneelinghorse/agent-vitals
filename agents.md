...
**Version**: 1.11.0 (Production/Stable)  
**License**: MIT
...
## Detector Status (as of v1.11.0)

| Detector | Gate Status | Precision | Recall | Notes |
|----------|------------|-----------|--------|-------|
| loop | HARD GATE | P=0.986 [0.960] | R=1.000 [0.982] | First promoted detector |
| stuck | HARD GATE | P=0.919 [0.838] | R=0.838 | Suppressed when loop co-fires |
| confabulation | SOFT | P_lb=0.790 | — | 1pp short of promotion |
| thrash | SOFT | — | — | FP from segmentation artifacts |
| runaway_cost | SOFT | — | — | Insufficient positives in corpus |
